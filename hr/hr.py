...
class hr_payslip_run(osv.osv):
    ...
    _columns = {
        ...
        'total_charge_patronale': fields.function(_get_charge_patronale, fnct_inv=_set_charge_patronale, string='Total Charges', type='float'),
        'total_charge_sociale': fields.function(_get_charge_sociale, fnct_inv=_set_charge_sociale, string='Total Prestations Sociales', type='float'),
    }
