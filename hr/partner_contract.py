...
class integc_hr_partner_contract(osv.osv):
    ...
    _columns = {
        ...
        'balance': fields.function(_get_amount_balance, digits_compute=dp.get_precision('Account'), string='Balance', store=False),
        ...
        'first_date': fields.function(_get_first_date, method=True, type='date', string="First Date"),
        'last_date': fields.function(_get_last_date, method=True, type='date', string="Last Date"),
        #'first_date': fields.function(lambda *a: time.strftime('%Y-%m-01'), method=True, type='date', string="First Date"),
        #'last_date': fields.function(lambda *a: str(datetime.now() + relativedelta.relativedelta(months=+1, day=1, days=-1))[:10], method=True, type='date', string="Last Date"),
    }
    _defaults = {
